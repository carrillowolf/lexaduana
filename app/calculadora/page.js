        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          ...
          {user && (
            <div className="mb-8 flex gap-3">
              <QuickAccessButton href="/dashboard" icon="📊" text="Dashboard" />
              <QuickAccessButton href="/comparador" icon="⚖️" text="Comparador" />
              <QuickAccessButton href="/favoritos" icon="⭐" text="Favoritos" />
              <QuickAccessButton href="/tipos-cambio" icon="💱" text="Tipos Cambio" />
            </div>
          )}
