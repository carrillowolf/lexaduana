...
import { favoritosDict } from '@/lib/i18n/favoritos';
...
export default function FavoritosPage() {
    ...
    const t = useTranslation(favoritosDict);
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-500 mt-1">
                                                        {t('country')}: {favorite.country_code || t('notSpecified')}
                                                        {favorite.cif_value && ` • ${t('cifValue')}: €${favorite.cif_value.toLocaleString()}`}
                                                    </p>
                                                    {favorite.notes && (
                                                    ...
                                                    <p className="text-xs text-gray-400 mt-1">
                                                        {t('saved')}: {new Date(favorite.created_at).toLocaleDateString()}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
