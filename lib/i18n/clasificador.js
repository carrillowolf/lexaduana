...
export const clasificadorDict = {
  es: {
    ...
    auth: {
      ...
      subtitle: 'Obtén el código TARIC de tu producto en segundos.',
      loginRequired: 'Inicia sesión para usar el clasificador.',
  ...
  en: {
    ...
    auth: {
      ...
      subtitle: 'Get the TARIC code for your product in seconds.',
      loginRequired: 'Sign in to use the classifier.',
      login: 'Sign in',
    },
