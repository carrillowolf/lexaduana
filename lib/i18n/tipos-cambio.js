...
export const tiposCambioDict = {
  es: {
    hero: {
      badge: 'Banco Central Europeo · BOE',
      title: 'Tipos de cambio',
      titleHighlight: 'para aduanas',
      subtitle: 'Cotizaciones oficiales del BCE publicadas en el BOE, aplicables al cálculo del valor en aduana durante el mes en vigor.',
    },
    loading: 'Cargando…',
    upcoming: {
  ...
  en: {
    hero: {
      badge: 'European Central Bank · BOE',
      title: 'Exchange rates',
      titleHighlight: 'for customs',
      subtitle: 'Official ECB quotations published in the Spanish Official Gazette (BOE), applicable to customs value calculations during the current month.',
    },
    loading: 'Loading…',
    upcoming: {
