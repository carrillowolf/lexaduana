...
export function generateRecommendations(snapshot) {
  ...
  // ========================================================
  // 5. Próximo informe trimestral
  // ========================================================
  recommendations.push({
    id: 'quarterly_reporting',
    priority: 'low',
    titleEs: 'Informes trimestrales obligatorios',
    titleEn: 'Mandatory quarterly reports',
    bodyEs:
      'Recuerde que durante el período de transición debe presentar informes trimestrales ' +
      'CBAM en el portal de la Comisión (CBAM Transitional Registry). El plazo es de 1 mes ' +
      'tras el fin del trimestre. LexAduana puede asistirle en la preparación y presentación ' +
      'de estos informes.',
    bodyEn:
      'Remember that during the transitional period you must submit quarterly CBAM reports ' +
      'to the Commission portal (CBAM Transitional Registry). The deadline is 1 month after ' +
      'the end of the quarter. LexAduana can assist you in preparing and submitting these reports.',
  })
