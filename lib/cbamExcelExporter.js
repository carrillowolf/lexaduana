 ...
 *
 * NOTA: actualmente sin consumidores en el árbol de código. Se deja la
 * función porque la estructura de salida es útil y puede reutilizarse
 * cuando se exporte el historial nuevo (cbam_calculator_saves) a Excel.
 *
 * @param {Array} calculations - Array de cálculos CBAM (formato del
 *   historial legacy o equivalente). Cada entrada debe exponer:
 *   tonnes, total_cost, total_emissions, sector_id, cn_code, etc.
 */
