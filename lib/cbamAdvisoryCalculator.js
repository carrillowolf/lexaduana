 ...
 *
 * Devuelve siempre { price, source, date } con un valor utilizable —
 * nunca falla. Origen registrado para auditoría del informe.
 */
...
export async function calculateProducts({ products, year = 2026 }) {
  ...
  const cbamPriceSource = priceInfo.source
  ...
  return {
    ...
    totals: {
      ...
      co2PriceSource: cbamPriceSource,
    ...
    regParams: {
      ...
      certificatePriceSource: cbamPriceSource,
