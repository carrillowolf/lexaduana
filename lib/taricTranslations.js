...
export const measureTypes = {
  ...
  474: { es: 'Restricción (sanciones)', en: 'Restriction (sanctions)', icon: '🚫' },
  475: { es: 'Restricción de despacho a libre práctica', en: 'Restriction on entry into free circulation', icon: '⚠️' },
  ...
  710: { es: 'Control CITES — Importación', en: 'CITES control — Import', icon: '🦎' },
  711: { es: 'Control CITES — Exportación', en: 'CITES control — Export', icon: '🦎' },
  713: { es: 'Control OGM (organismos modificados)', en: 'GMO control', icon: '🧬' },
  714: { es: 'Control de importación', en: 'Import control', icon: '🔍' },
  715: { es: 'Control CITES — Exportación', en: 'CITES control — Export', icon: '🦎' },
  719: { es: 'Control pesca INDNR (ilegal)', en: 'IUU fishing control', icon: '🐟' },
  724: { es: 'Control seguridad alimentos y piensos', en: 'Food and feed safety control', icon: '🍽️' },
  726: { es: 'Control sustancias que agotan la capa de ozono', en: 'Ozone-depleting substances control', icon: '🌐' },
  728: { es: 'Control bienes de lujo (sanciones)', en: 'Luxury goods control (sanctions)', icon: '💎' },
  731: { es: 'Control de certificación previa a la exportación', en: 'Pre-export certification control', icon: '📋' },
  732: { es: 'Control de importación', en: 'Import control', icon: '🔍' },
  ...
  755: { es: 'Control residuos (importación)', en: 'Waste control (import)', icon: '♻️' },
  760: { es: 'Control REACH (sustancias químicas)', en: 'REACH control (chemicals)', icon: '🧪' },
  761: { es: 'Control POP (contaminantes orgánicos)', en: 'POP control (organic pollutants)', icon: '🧪' },
  762: { es: 'Control gases fluorados', en: 'Fluorinated gas control', icon: '🌡️' },
...
export const certificates = {
  ...
  // CBAM - Carbon Border Adjustment Mechanism (desde 01/01/2026)
  Y128: { es: 'Número de cuenta CBAM del declarante autorizado', en: 'CBAM account number of authorised declarant', icon: '🌍' },
  Y134: { es: 'Exención CBAM: Origen Büsingen, Heligoland o Livigno', en: 'CBAM exemption: Büsingen, Heligoland or Livigno origin', icon: '🏔️' },
  Y135: { es: 'Exención CBAM: Mercancías para uso militar', en: 'CBAM exemption: Goods for military use', icon: '🎖️' },
  Y136: { es: 'Exención CBAM: Electricidad/hidrógeno de zona económica exclusiva UE', en: 'CBAM exemption: Electricity/hydrogen from EU EEZ', icon: '⚡' },
  Y137: { es: 'Exención CBAM de minimis (< 50t/año)', en: 'CBAM de minimis exemption (< 50t/year)', icon: '📦' },
  Y237: { es: 'Mercancías de origen UE (exentas CBAM)', en: 'EU origin goods (CBAM exempt)', icon: '🇪🇺' },
  Y238: { es: 'Solicitud declarante CBAM presentada antes 31/03/2026', en: 'CBAM declarant application submitted before 31/03/2026', icon: '📋' },
