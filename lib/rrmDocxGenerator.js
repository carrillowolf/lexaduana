...
// Fila a ancho completo (1 sola columna al 100%).
function buildFullWidthFieldRow(code, label, footnoteRef, body, opts = {}) {
  return new TableRow({
    height: { value: 800, rule: HeightRule.ATLEAST },
    cantSplit: !!opts.cantSplit,
    children: [buildFieldCellNode(code, label, footnoteRef, body, 100)],
  })
}

// Fila multi-columna: array de { code, label, footnoteRef, body, widthPercent }.
// La suma de widthPercent debe ser 100.
function buildMultiColumnRow(cells, opts = {}) {
  return new TableRow({
    height: { value: 800, rule: HeightRule.ATLEAST },
    cantSplit: !!opts.cantSplit,
    children: cells.map((c) =>
      buildFieldCellNode(c.code, c.label, c.footnoteRef || null, c.body, c.widthPercent || 100),
    ),
  })
}

// Envuelve un array de TableRow en una Table al 100% de ancho.
...
function buildCommonRequisitos(data) {
  ...
  return [
    ...
    buildFieldsTable([
      buildMultiColumnRow([
        { code: '31 01', label: 'Tipo de Código de Solicitud (REM/REP)', footnoteRef: '1', body: reqType.code, widthPercent: 33 },
        { code: '31 03', label: 'Tipo de Solicitud', body: data.subRequestType || '1', widthPercent: 34 },
        { code: '31 06', label: 'Número de referencia de la decisión', footnoteRef: '2', body: data.priorDecisionRef || '', widthPercent: 33 },
      ]),
      buildMultiColumnRow([
        { code: 'Firma/autenticación', label: '', body: '', widthPercent: 50 },
        { code: '31 07', label: 'Autoridad Aduanera que toma la decisión', footnoteRef: '3', body: data.customsOffice || '', widthPercent: 50 },
      ]),
    ]),
    p('', { size: 8 }),
    ...
    buildFieldsTable([
      buildFullWidthFieldRow('32 04', 'Documentación Adjunta', null, attachmentsValue),
    ]),
    p('', { size: 8 }),
    ...
    buildFieldsTable([
      buildMultiColumnRow([
        { code: '33 01/33 02', label: 'Solicitante/titular de la autorización o la decisión', footnoteRef: '4', body: data.importer?.name || '', widthPercent: 50 },
        { code: 'Identificación del solicitante/titular de la autorización o la decisión', label: '', body: importerIdBody, widthPercent: 50 },
      ]),
      buildMultiColumnRow([
        { code: '33 03', label: 'Representante', footnoteRef: '5', body: data.representative?.name || '', widthPercent: 50 },
        { code: 'Identificación del representante', label: '', body: representativeIdBody, widthPercent: 50 },
      ]),
      buildFullWidthFieldRow('33 06', 'Persona de contacto responsable de la solicitud', '*', contactValue),
    ]),
    p('', { size: 8 }),
    ...
    buildFieldsTable([
      buildMultiColumnRow([
        { code: '34 01', label: 'Lugar', body: data.place || data.applicationCity || 'Madrid', widthPercent: 33 },
        { code: '34 02', label: 'Fecha de la solicitud', body: data.requestDate || '', widthPercent: 34 },
        { code: '34 06', label: 'Fecha solicitada de entrada en vigor', body: data.effectiveDate || '', widthPercent: 33 },
      ]),
      buildFullWidthFieldRow('34 08', 'Ubicación de las mercancías', '6', data.goodsLocation || ''),
    ]),
    p('', { size: 8 }),
    ...
    buildFieldsTable([
      buildMultiColumnRow([
        { code: '35 01', label: 'Información sobre las mercancías', body: goodsInfo, widthPercent: 33 },
        { code: '35 01', label: 'Designación de las mercancías', body: goodsDesignation, widthPercent: 34 },
        { code: '35 01', label: 'Volumen de las mercancías', body: goodsVolume, widthPercent: 33 },
      ]),
    ]),
    p('', { size: 8 }),
    ...
    buildFieldsTable([
      buildFullWidthFieldRow('38 05', 'Información Adicional', '*', data.additionalInfo || ''),
    ]),
  ]
}
...
function buildSpecificRequisitos(data) {
  ...
  return [
    ...
    p('', { size: 8 }),
    buildFieldsTable([
      buildFullWidthFieldRow('48 01', 'Título de cobro', '7', data.mrn || ''),
      buildMultiColumnRow([
        {
          code: '48 02',
      ...
      buildMultiColumnRow([
        { code: '48 06', label: 'Valor en aduana', footnoteRef: '11', body: value4806, widthPercent: 25 },
        {
          code: '48 07',
      ...
      buildFullWidthFieldRow('48 09', 'Base jurídica', '14', legal4809),
      buildFullWidthFieldRow('48 10', 'Uso o destino de las mercancías', null, data.useDestination || DEFAULT_USO_DESTINO),
      buildFullWidthFieldRow('48 11', 'Plazo para la realización de las formalidades', null, ''),
      buildFullWidthFieldRow('48 12', 'Declaración de la autoridad aduanera que toma la decisión', null, ''),
      buildFullWidthFieldRow(
        '48 13',
      ...
      buildFullWidthFieldRow('48 14', 'Datos del banco y de la cuenta.', '16', bank4814, { cantSplit: true }),
    ]),
  ]
}
