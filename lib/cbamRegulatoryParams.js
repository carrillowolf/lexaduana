...
// ============================================================
//
// El precio de los certificados CBAM se calcula y publica semanalmente por
// la Comisión Europea como media del precio de cierre EUA (EU Allowance) de
// la semana anterior, conforme al Reglamento de Ejecución (UE) 2025/2548 de
// la Comisión, de 10 de diciembre de 2025.
//
// Los valores aquí reflejan el precio orientativo publicado más reciente.
// En producción convendría:
//  - Poblar tabla cbam_certificate_prices desde un job semanal
//  - Consultarla aquí en lugar de hardcodear
//
// Por ahora, valor orientativo para Q1 2026 publicado por la CE.

export const CBAM_CERTIFICATE_PRICE_DEFAULT = 74.76 // €/tCO₂e
...
export function getCbamCertificatePrice() {
  return {
    price: CBAM_CERTIFICATE_PRICE_DEFAULT,
    date: CBAM_CERTIFICATE_PRICE_DATE,
    source: CBAM_CERTIFICATE_PRICE_SOURCE,
    note: 'Precio orientativo. La CE publica el precio oficial semanalmente.',
  }
}
