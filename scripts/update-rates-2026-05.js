/**
 * Actualización de tipos de cambio BCE - Mayo 2026
 *
 * Fuentes:
 *   ACTUALES:  BOE-A-2026-6470 (18 mar 2026) → vigentes desde 1 abril 2026
 *              (lo que antes era "upcoming" pasa ahora a "current")
 *   PRÓXIMOS:  BOE-A-2026-8866 (22 abr 2026) → vigentes desde 1 mayo 2026
 *
 * Uso: node scripts/update-rates-2026-05.js [--dry-run]
 */
...
// Pasan de "upcoming" (ciclo anterior) a "current" (ciclo actual)
// ============================================================
const currentRates = [
...
// ============================================================
// DATOS: BOE-A-2026-8866 (22 abr 2026) → vigentes 1 mayo 2026
// Publicado en BOE Núm. 98, Sec. III, Pág. 56985-56986
// Resolución de 21 de abril de 2026 del Banco de España
// ============================================================
const upcomingRates = [
  { currency_code: 'AUD', currency_name: 'Dólar australiano',    rate: 1.6423 },
  { currency_code: 'BRL', currency_name: 'Real brasileño',       rate: 5.8410 },
  { currency_code: 'CAD', currency_name: 'Dólar canadiense',     rate: 1.6070 },
  { currency_code: 'CHF', currency_name: 'Franco suizo',         rate: 0.9172 },
  { currency_code: 'CNY', currency_name: 'Yuan renminbi chino',  rate: 8.0202 },
  { currency_code: 'CZK', currency_name: 'Corona checa',         rate: 24.301 },
  { currency_code: 'DKK', currency_name: 'Corona danesa',        rate: 7.4734 },
  { currency_code: 'GBP', currency_name: 'Libra esterlina',      rate: 0.87035 },
  { currency_code: 'HKD', currency_name: 'Dólar de Hong Kong',   rate: 9.2140 },
  { currency_code: 'HUF', currency_name: 'Forinto húngaro',      rate: 362.15 },
  { currency_code: 'IDR', currency_name: 'Rupia indonesia',      rate: 20154.05 },
  { currency_code: 'ILS', currency_name: 'Shekel israelí',       rate: 3.5202 },
  { currency_code: 'INR', currency_name: 'Rupia india',          rate: 110.0275 },
  { currency_code: 'ISK', currency_name: 'Corona islandesa',     rate: 143.60 },
  { currency_code: 'JPY', currency_name: 'Yen japonés',          rate: 187.14 },
  { currency_code: 'KRW', currency_name: 'Won surcoreano',       rate: 1729.57 },
  { currency_code: 'MXN', currency_name: 'Peso mexicano',        rate: 20.3666 },
  { currency_code: 'MYR', currency_name: 'Ringgit malasio',      rate: 4.6491 },
  { currency_code: 'NOK', currency_name: 'Corona noruega',       rate: 10.9670 },
  { currency_code: 'NZD', currency_name: 'Dólar neozelandés',    rate: 1.9907 },
  { currency_code: 'PHP', currency_name: 'Peso filipino',        rate: 70.407 },
  { currency_code: 'PLN', currency_name: 'Zloty polaco',         rate: 4.2295 },
  { currency_code: 'RON', currency_name: 'Leu rumano',           rate: 5.0984 },
  { currency_code: 'SEK', currency_name: 'Corona sueca',         rate: 10.7495 },
  { currency_code: 'SGD', currency_name: 'Dólar de Singapur',    rate: 1.4961 },
  { currency_code: 'THB', currency_name: 'Baht tailandés',       rate: 37.696 },
  { currency_code: 'TRY', currency_name: 'Lira turca',           rate: 52.8274 },
  { currency_code: 'USD', currency_name: 'Dólar USA',            rate: 1.1767 },
  { currency_code: 'ZAR', currency_name: 'Rand sudafricano',     rate: 19.2620 },
].map(r => ({
  ...r,
  effective_from: '2026-05-01',
  publication_date: '2026-04-22',
  boe_reference: 'BOE-A-2026-8866',
}))
...
async function run() {
  ...
  // --- CURRENT ---
  console.log(`📊 Tipos ACTUALES: ${currentRates.length} monedas (BOE-A-2026-6470, vigentes desde 2026-04-01)`)
  if (isDryRun) {
  ...
  // --- UPCOMING ---
  console.log(`\n📅 Tipos PRÓXIMOS: ${upcomingRates.length} monedas (BOE-A-2026-8866, vigentes desde 2026-05-01)`)
  if (isDryRun) {
  ...
  console.log('   Banner se activará automáticamente el 24 de abril (7 días antes del 1 de mayo)')
}
